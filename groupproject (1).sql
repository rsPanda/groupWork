...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2017 at 01:10 AM
...
(20, 'asdfds', 'placeholder.jpg', 2, 'asdfdsf', 5, 'asdfds');
...
(1, 7, 'Super Mario Odyssey ', '0000-00-00', 'When playing Super Mario Odyssey you want to find out more. Curiosity is encouraged, and in deed this curiosity is it\'s own reward', 1, 'http://www.eurogamer.net/articles/2017-11-02-mario-odyssey-encourages-curiosity-and-what-higher-praise-is-there'),
...
(7, 'New', 'User', 'new@user.com', 'newuser', 1, '2017-11-12 20:27:07');
...
--
ALTER TABLE `gamelist`
  MODIFY `gameID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `userfav`
  MODIFY `favID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
