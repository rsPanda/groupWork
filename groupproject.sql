...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2017 at 11:21 AM
...
INSERT INTO `gamenews` (`articleID`, `gameID`, `articleDesc`, `outletID`, `articleLink`) VALUES
(1, 7, 'When playing Super Mario Odyssey you want to find out more. Curiosity is encouraged, and in deed this curiosity is it\'s own reward', 1, 'http://www.eurogamer.net/articles/2017-11-02-mario-odyssey-encourages-curiosity-and-what-higher-praise-is-there'),
(2, 12, 'In light of the current loot box controversies EA have made changes to the Battlefront 2 loot crate and progression systems.', 1, 'http://www.eurogamer.net/articles/2017-11-01-ea-announces-star-wars-battlefront-2-loot-crate-and-progression-changes'),
(3, 9, 'How to complete the sidequests that make up Assassin\'s Creed Origins.', 1, 'http://www.eurogamer.net/articles/2017-11-01-assassins-creed-origins-sidequests-4849'),
(4, 1, 'Find the best pre-order deals for Call of Duty WWII', 2, 'http://uk.ign.com/articles/2017/11/02/uk-daily-deals-preorder-call-of-duty-wwii-on-ps4-and-xbox-one-for-under-38'),
(5, 7, 'The IGN review of Super Mario Odyssey', 2, 'http://uk.ign.com/articles/2017/10/26/super-mario-odyssey-review'),
(6, 5, 'Kotaku\'s review of Wolfenstein 2: The New Colossus.', 3, 'http://www.kotaku.co.uk/2017/10/30/wolfenstein-ii-the-new-colossus-the-kotaku-review'),
(7, 15, 'Kotaku\'s thoughts on Gwent, and their growing love for the card game, from the beloved game The Witcher 3.', 3, 'http://www.kotaku.co.uk/2017/11/01/gwent-keeps-getting-better'),
(8, 11, 'View the first 15 minutes of Need for Speed Payback', 4, 'https://www.polygon.com/videos/2017/11/1/16587910/need-for-speed-payback-gameplay-video');
...
INSERT INTO `users` (`userID`, `firstName`, `lastName`, `email`, `password`, `admin`) VALUES
(1, 'Christine', 'Sarakinis', 'cam109@hotmail.co.uk', 'admin1', 1),
(2, 'Ruby', 'Shakya', 'rubysky24@gmail.com', 'admin2', 1),
(3, 'Claire', 'King', 'clairecollking@gmail.com', 'admin3', 1),
(4, 'Christopher', 'Sanderson', 'chsanderson97@gmail.com', 'admin4', 1),
(5, 'Guest', 'Guest', 'guest@guest.com', 'guest', 0);
...
--
ALTER TABLE `console`
  MODIFY `consoleID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `gamelist`
  MODIFY `gameID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
